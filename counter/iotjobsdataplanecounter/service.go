...
// IoTJobsDataPlane counts the API operations made to AWS IoT Jobs Data Plane.
type IoTJobsDataPlane struct {
	svc    iotjobsdataplaneiface.IoTJobsDataPlaneAPI
	counts sync.Map
}

var _ iotjobsdataplaneiface.IoTJobsDataPlaneAPI = &IoTJobsDataPlane{}

// New creates a new instance of the IoTJobsDataPlane counter.
func New(svc iotjobsdataplaneiface.IoTJobsDataPlaneAPI) *IoTJobsDataPlane {
	return &IoTJobsDataPlane{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *IoTJobsDataPlane) Counters() map[string]int64 {
...
func (c *IoTJobsDataPlane) incViaRequestOption(op string) request.Option {
