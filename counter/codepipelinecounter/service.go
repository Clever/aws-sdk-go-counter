...
// CodePipeline counts the API operations made to AWS CodePipeline.
type CodePipeline struct {
	svc    codepipelineiface.CodePipelineAPI
	counts sync.Map
}

var _ codepipelineiface.CodePipelineAPI = &CodePipeline{}

// New creates a new instance of the CodePipeline counter.
func New(svc codepipelineiface.CodePipelineAPI) *CodePipeline {
	return &CodePipeline{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *CodePipeline) Counters() map[string]int64 {
...
func (c *CodePipeline) incViaRequestOption(op string) request.Option {
