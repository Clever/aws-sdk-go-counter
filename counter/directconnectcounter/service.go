...
// DirectConnect counts the API operations made to AWS Direct Connect.
type DirectConnect struct {
	svc    directconnectiface.DirectConnectAPI
	counts sync.Map
}

var _ directconnectiface.DirectConnectAPI = &DirectConnect{}

// New creates a new instance of the DirectConnect counter.
func New(svc directconnectiface.DirectConnectAPI) *DirectConnect {
	return &DirectConnect{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *DirectConnect) Counters() map[string]int64 {
...
func (c *DirectConnect) incViaRequestOption(op string) request.Option {
