...
// ECS counts the API operations made to Amazon EC2 Container Service.
type ECS struct {
	svc    ecsiface.ECSAPI
	counts sync.Map
}

var _ ecsiface.ECSAPI = &ECS{}

// New creates a new instance of the ECS counter.
func New(svc ecsiface.ECSAPI) *ECS {
	return &ECS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *ECS) Counters() map[string]int64 {
...
func (c *ECS) incViaRequestOption(op string) request.Option {
