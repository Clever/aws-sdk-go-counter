...
// SFN counts the API operations made to AWS Step Functions.
type SFN struct {
	svc    sfniface.SFNAPI
	counts sync.Map
}

var _ sfniface.SFNAPI = &SFN{}

// New creates a new instance of the SFN counter.
func New(svc sfniface.SFNAPI) *SFN {
	return &SFN{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *SFN) Counters() map[string]int64 {
...
func (c *SFN) incViaRequestOption(op string) request.Option {
