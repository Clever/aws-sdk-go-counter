...
// Glacier counts the API operations made to Amazon Glacier.
type Glacier struct {
	svc    glacieriface.GlacierAPI
	counts sync.Map
}

var _ glacieriface.GlacierAPI = &Glacier{}

// New creates a new instance of the Glacier counter.
func New(svc glacieriface.GlacierAPI) *Glacier {
	return &Glacier{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Glacier) Counters() map[string]int64 {
...
func (c *Glacier) incViaRequestOption(op string) request.Option {
