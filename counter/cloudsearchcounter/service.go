...
// CloudSearch counts the API operations made to Amazon CloudSearch.
type CloudSearch struct {
	svc    cloudsearchiface.CloudSearchAPI
	counts sync.Map
}

var _ cloudsearchiface.CloudSearchAPI = &CloudSearch{}

// New creates a new instance of the CloudSearch counter.
func New(svc cloudsearchiface.CloudSearchAPI) *CloudSearch {
	return &CloudSearch{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *CloudSearch) Counters() map[string]int64 {
...
func (c *CloudSearch) incViaRequestOption(op string) request.Option {
