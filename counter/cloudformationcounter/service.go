...
// CloudFormation counts the API operations made to AWS CloudFormation.
type CloudFormation struct {
	svc    cloudformationiface.CloudFormationAPI
	counts sync.Map
}

var _ cloudformationiface.CloudFormationAPI = &CloudFormation{}

// New creates a new instance of the CloudFormation counter.
func New(svc cloudformationiface.CloudFormationAPI) *CloudFormation {
	return &CloudFormation{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *CloudFormation) Counters() map[string]int64 {
...
func (c *CloudFormation) incViaRequestOption(op string) request.Option {
