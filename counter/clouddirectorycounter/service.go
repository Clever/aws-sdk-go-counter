...
// CloudDirectory counts the API operations made to Amazon CloudDirectory.
type CloudDirectory struct {
	svc    clouddirectoryiface.CloudDirectoryAPI
	counts sync.Map
}

var _ clouddirectoryiface.CloudDirectoryAPI = &CloudDirectory{}

// New creates a new instance of the CloudDirectory counter.
func New(svc clouddirectoryiface.CloudDirectoryAPI) *CloudDirectory {
	return &CloudDirectory{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *CloudDirectory) Counters() map[string]int64 {
...
func (c *CloudDirectory) incViaRequestOption(op string) request.Option {
