...
// MediaStore counts the API operations made to AWS Elemental MediaStore.
type MediaStore struct {
	svc    mediastoreiface.MediaStoreAPI
	counts sync.Map
}

var _ mediastoreiface.MediaStoreAPI = &MediaStore{}

// New creates a new instance of the MediaStore counter.
func New(svc mediastoreiface.MediaStoreAPI) *MediaStore {
	return &MediaStore{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *MediaStore) Counters() map[string]int64 {
...
func (c *MediaStore) incViaRequestOption(op string) request.Option {
