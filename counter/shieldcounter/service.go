...
// Shield counts the API operations made to AWS Shield.
type Shield struct {
	svc    shieldiface.ShieldAPI
	counts sync.Map
}

var _ shieldiface.ShieldAPI = &Shield{}

// New creates a new instance of the Shield counter.
func New(svc shieldiface.ShieldAPI) *Shield {
	return &Shield{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Shield) Counters() map[string]int64 {
...
func (c *Shield) incViaRequestOption(op string) request.Option {
