...
// KinesisVideo counts the API operations made to Amazon Kinesis Video Streams.
type KinesisVideo struct {
	svc    kinesisvideoiface.KinesisVideoAPI
	counts sync.Map
}

var _ kinesisvideoiface.KinesisVideoAPI = &KinesisVideo{}

// New creates a new instance of the KinesisVideo counter.
func New(svc kinesisvideoiface.KinesisVideoAPI) *KinesisVideo {
	return &KinesisVideo{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *KinesisVideo) Counters() map[string]int64 {
...
func (c *KinesisVideo) incViaRequestOption(op string) request.Option {
