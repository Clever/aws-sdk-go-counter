...
// EFS counts the API operations made to Amazon Elastic File System.
type EFS struct {
	svc    efsiface.EFSAPI
	counts sync.Map
}

var _ efsiface.EFSAPI = &EFS{}

// New creates a new instance of the EFS counter.
func New(svc efsiface.EFSAPI) *EFS {
	return &EFS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *EFS) Counters() map[string]int64 {
...
func (c *EFS) incViaRequestOption(op string) request.Option {
