...
// AppStream counts the API operations made to Amazon AppStream.
type AppStream struct {
	svc    appstreamiface.AppStreamAPI
	counts sync.Map
}

var _ appstreamiface.AppStreamAPI = &AppStream{}

// New creates a new instance of the AppStream counter.
func New(svc appstreamiface.AppStreamAPI) *AppStream {
	return &AppStream{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *AppStream) Counters() map[string]int64 {
...
func (c *AppStream) incViaRequestOption(op string) request.Option {
