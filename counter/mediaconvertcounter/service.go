...
// MediaConvert counts the API operations made to AWS Elemental MediaConvert.
type MediaConvert struct {
	svc    mediaconvertiface.MediaConvertAPI
	counts sync.Map
}

var _ mediaconvertiface.MediaConvertAPI = &MediaConvert{}

// New creates a new instance of the MediaConvert counter.
func New(svc mediaconvertiface.MediaConvertAPI) *MediaConvert {
	return &MediaConvert{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *MediaConvert) Counters() map[string]int64 {
...
func (c *MediaConvert) incViaRequestOption(op string) request.Option {
