...
// ElasticBeanstalk counts the API operations made to AWS Elastic Beanstalk.
type ElasticBeanstalk struct {
	svc    elasticbeanstalkiface.ElasticBeanstalkAPI
	counts sync.Map
}

var _ elasticbeanstalkiface.ElasticBeanstalkAPI = &ElasticBeanstalk{}

// New creates a new instance of the ElasticBeanstalk counter.
func New(svc elasticbeanstalkiface.ElasticBeanstalkAPI) *ElasticBeanstalk {
	return &ElasticBeanstalk{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *ElasticBeanstalk) Counters() map[string]int64 {
...
func (c *ElasticBeanstalk) incViaRequestOption(op string) request.Option {
