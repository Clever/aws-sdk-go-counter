...
// MigrationHub counts the API operations made to AWS Migration Hub.
type MigrationHub struct {
	svc    migrationhubiface.MigrationHubAPI
	counts sync.Map
}

var _ migrationhubiface.MigrationHubAPI = &MigrationHub{}

// New creates a new instance of the MigrationHub counter.
func New(svc migrationhubiface.MigrationHubAPI) *MigrationHub {
	return &MigrationHub{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *MigrationHub) Counters() map[string]int64 {
...
func (c *MigrationHub) incViaRequestOption(op string) request.Option {
