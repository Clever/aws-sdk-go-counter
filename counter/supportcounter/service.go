...
// Support counts the API operations made to AWS Support.
type Support struct {
	svc    supportiface.SupportAPI
	counts sync.Map
}

var _ supportiface.SupportAPI = &Support{}

// New creates a new instance of the Support counter.
func New(svc supportiface.SupportAPI) *Support {
	return &Support{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Support) Counters() map[string]int64 {
...
func (c *Support) incViaRequestOption(op string) request.Option {
