...
// Glue counts the API operations made to AWS Glue.
type Glue struct {
	svc    glueiface.GlueAPI
	counts sync.Map
}

var _ glueiface.GlueAPI = &Glue{}

// New creates a new instance of the Glue counter.
func New(svc glueiface.GlueAPI) *Glue {
	return &Glue{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Glue) Counters() map[string]int64 {
...
func (c *Glue) incViaRequestOption(op string) request.Option {
