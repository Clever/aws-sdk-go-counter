...
// EMR counts the API operations made to Amazon Elastic MapReduce.
type EMR struct {
	svc    emriface.EMRAPI
	counts sync.Map
}

var _ emriface.EMRAPI = &EMR{}

// New creates a new instance of the EMR counter.
func New(svc emriface.EMRAPI) *EMR {
	return &EMR{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *EMR) Counters() map[string]int64 {
...
func (c *EMR) incViaRequestOption(op string) request.Option {
