...
// AutoScaling counts the API operations made to Auto Scaling.
type AutoScaling struct {
	svc    autoscalingiface.AutoScalingAPI
	counts sync.Map
}

var _ autoscalingiface.AutoScalingAPI = &AutoScaling{}

// New creates a new instance of the AutoScaling counter.
func New(svc autoscalingiface.AutoScalingAPI) *AutoScaling {
	return &AutoScaling{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *AutoScaling) Counters() map[string]int64 {
...
func (c *AutoScaling) incViaRequestOption(op string) request.Option {
