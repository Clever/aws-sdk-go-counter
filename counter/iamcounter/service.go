...
// IAM counts the API operations made to AWS Identity and Access Management.
type IAM struct {
	svc    iamiface.IAMAPI
	counts sync.Map
}

var _ iamiface.IAMAPI = &IAM{}

// New creates a new instance of the IAM counter.
func New(svc iamiface.IAMAPI) *IAM {
	return &IAM{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *IAM) Counters() map[string]int64 {
...
func (c *IAM) incViaRequestOption(op string) request.Option {
