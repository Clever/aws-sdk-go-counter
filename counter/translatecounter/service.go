...
// Translate counts the API operations made to Amazon Translate.
type Translate struct {
	svc    translateiface.TranslateAPI
	counts sync.Map
}

var _ translateiface.TranslateAPI = &Translate{}

// New creates a new instance of the Translate counter.
func New(svc translateiface.TranslateAPI) *Translate {
	return &Translate{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Translate) Counters() map[string]int64 {
...
func (c *Translate) incViaRequestOption(op string) request.Option {
