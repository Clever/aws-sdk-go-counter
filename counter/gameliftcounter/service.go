...
// GameLift counts the API operations made to Amazon GameLift.
type GameLift struct {
	svc    gameliftiface.GameLiftAPI
	counts sync.Map
}

var _ gameliftiface.GameLiftAPI = &GameLift{}

// New creates a new instance of the GameLift counter.
func New(svc gameliftiface.GameLiftAPI) *GameLift {
	return &GameLift{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *GameLift) Counters() map[string]int64 {
...
func (c *GameLift) incViaRequestOption(op string) request.Option {
