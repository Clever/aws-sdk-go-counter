...
// Mobile counts the API operations made to AWS Mobile.
type Mobile struct {
	svc    mobileiface.MobileAPI
	counts sync.Map
}

var _ mobileiface.MobileAPI = &Mobile{}

// New creates a new instance of the Mobile counter.
func New(svc mobileiface.MobileAPI) *Mobile {
	return &Mobile{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Mobile) Counters() map[string]int64 {
...
func (c *Mobile) incViaRequestOption(op string) request.Option {
