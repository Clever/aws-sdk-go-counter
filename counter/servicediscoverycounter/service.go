...
// ServiceDiscovery counts the API operations made to Amazon Route 53 Auto Naming.
type ServiceDiscovery struct {
	svc    servicediscoveryiface.ServiceDiscoveryAPI
	counts sync.Map
}

var _ servicediscoveryiface.ServiceDiscoveryAPI = &ServiceDiscovery{}

// New creates a new instance of the ServiceDiscovery counter.
func New(svc servicediscoveryiface.ServiceDiscoveryAPI) *ServiceDiscovery {
	return &ServiceDiscovery{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *ServiceDiscovery) Counters() map[string]int64 {
...
func (c *ServiceDiscovery) incViaRequestOption(op string) request.Option {
