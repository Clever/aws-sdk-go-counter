...
// WorkDocs counts the API operations made to Amazon WorkDocs.
type WorkDocs struct {
	svc    workdocsiface.WorkDocsAPI
	counts sync.Map
}

var _ workdocsiface.WorkDocsAPI = &WorkDocs{}

// New creates a new instance of the WorkDocs counter.
func New(svc workdocsiface.WorkDocsAPI) *WorkDocs {
	return &WorkDocs{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *WorkDocs) Counters() map[string]int64 {
...
func (c *WorkDocs) incViaRequestOption(op string) request.Option {
