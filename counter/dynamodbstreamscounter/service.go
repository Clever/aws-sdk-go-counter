...
// DynamoDBStreams counts the API operations made to Amazon DynamoDB Streams.
type DynamoDBStreams struct {
	svc    dynamodbstreamsiface.DynamoDBStreamsAPI
	counts sync.Map
}

var _ dynamodbstreamsiface.DynamoDBStreamsAPI = &DynamoDBStreams{}

// New creates a new instance of the DynamoDBStreams counter.
func New(svc dynamodbstreamsiface.DynamoDBStreamsAPI) *DynamoDBStreams {
	return &DynamoDBStreams{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *DynamoDBStreams) Counters() map[string]int64 {
...
func (c *DynamoDBStreams) incViaRequestOption(op string) request.Option {
