...
// SWF counts the API operations made to Amazon Simple Workflow Service.
type SWF struct {
	svc    swfiface.SWFAPI
	counts sync.Map
}

var _ swfiface.SWFAPI = &SWF{}

// New creates a new instance of the SWF counter.
func New(svc swfiface.SWFAPI) *SWF {
	return &SWF{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *SWF) Counters() map[string]int64 {
...
func (c *SWF) incViaRequestOption(op string) request.Option {
