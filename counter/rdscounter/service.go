...
// RDS counts the API operations made to Amazon Relational Database Service.
type RDS struct {
	svc    rdsiface.RDSAPI
	counts sync.Map
}

var _ rdsiface.RDSAPI = &RDS{}

// New creates a new instance of the RDS counter.
func New(svc rdsiface.RDSAPI) *RDS {
	return &RDS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *RDS) Counters() map[string]int64 {
...
func (c *RDS) incViaRequestOption(op string) request.Option {
