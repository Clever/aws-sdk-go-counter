...
// Lightsail counts the API operations made to Amazon Lightsail.
type Lightsail struct {
	svc    lightsailiface.LightsailAPI
	counts sync.Map
}

var _ lightsailiface.LightsailAPI = &Lightsail{}

// New creates a new instance of the Lightsail counter.
func New(svc lightsailiface.LightsailAPI) *Lightsail {
	return &Lightsail{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Lightsail) Counters() map[string]int64 {
...
func (c *Lightsail) incViaRequestOption(op string) request.Option {
