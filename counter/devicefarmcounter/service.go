...
// DeviceFarm counts the API operations made to AWS Device Farm.
type DeviceFarm struct {
	svc    devicefarmiface.DeviceFarmAPI
	counts sync.Map
}

var _ devicefarmiface.DeviceFarmAPI = &DeviceFarm{}

// New creates a new instance of the DeviceFarm counter.
func New(svc devicefarmiface.DeviceFarmAPI) *DeviceFarm {
	return &DeviceFarm{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *DeviceFarm) Counters() map[string]int64 {
...
func (c *DeviceFarm) incViaRequestOption(op string) request.Option {
