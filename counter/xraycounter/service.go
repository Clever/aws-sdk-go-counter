...
// XRay counts the API operations made to AWS X-Ray.
type XRay struct {
	svc    xrayiface.XRayAPI
	counts sync.Map
}

var _ xrayiface.XRayAPI = &XRay{}

// New creates a new instance of the XRay counter.
func New(svc xrayiface.XRayAPI) *XRay {
	return &XRay{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *XRay) Counters() map[string]int64 {
...
func (c *XRay) incViaRequestOption(op string) request.Option {
