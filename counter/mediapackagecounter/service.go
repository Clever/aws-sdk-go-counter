...
// MediaPackage counts the API operations made to AWS Elemental MediaPackage.
type MediaPackage struct {
	svc    mediapackageiface.MediaPackageAPI
	counts sync.Map
}

var _ mediapackageiface.MediaPackageAPI = &MediaPackage{}

// New creates a new instance of the MediaPackage counter.
func New(svc mediapackageiface.MediaPackageAPI) *MediaPackage {
	return &MediaPackage{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *MediaPackage) Counters() map[string]int64 {
...
func (c *MediaPackage) incViaRequestOption(op string) request.Option {
