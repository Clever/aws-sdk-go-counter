...
// CostExplorer counts the API operations made to AWS Cost Explorer Service.
type CostExplorer struct {
	svc    costexploreriface.CostExplorerAPI
	counts sync.Map
}

var _ costexploreriface.CostExplorerAPI = &CostExplorer{}

// New creates a new instance of the CostExplorer counter.
func New(svc costexploreriface.CostExplorerAPI) *CostExplorer {
	return &CostExplorer{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *CostExplorer) Counters() map[string]int64 {
...
func (c *CostExplorer) incViaRequestOption(op string) request.Option {
