...
// ACM counts the API operations made to AWS Certificate Manager.
type ACM struct {
	svc    acmiface.ACMAPI
	counts sync.Map
}

var _ acmiface.ACMAPI = &ACM{}

// New creates a new instance of the ACM counter.
func New(svc acmiface.ACMAPI) *ACM {
	return &ACM{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *ACM) Counters() map[string]int64 {
...
func (c *ACM) incViaRequestOption(op string) request.Option {
