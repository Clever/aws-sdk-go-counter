...
// SMS counts the API operations made to AWS Server Migration Service.
type SMS struct {
	svc    smsiface.SMSAPI
	counts sync.Map
}

var _ smsiface.SMSAPI = &SMS{}

// New creates a new instance of the SMS counter.
func New(svc smsiface.SMSAPI) *SMS {
	return &SMS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *SMS) Counters() map[string]int64 {
...
func (c *SMS) incViaRequestOption(op string) request.Option {
