...
// IoT counts the API operations made to AWS IoT.
type IoT struct {
	svc    iotiface.IoTAPI
	counts sync.Map
}

var _ iotiface.IoTAPI = &IoT{}

// New creates a new instance of the IoT counter.
func New(svc iotiface.IoTAPI) *IoT {
	return &IoT{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *IoT) Counters() map[string]int64 {
...
func (c *IoT) incViaRequestOption(op string) request.Option {
