...
// SNS counts the API operations made to Amazon Simple Notification Service.
type SNS struct {
	svc    snsiface.SNSAPI
	counts sync.Map
}

var _ snsiface.SNSAPI = &SNS{}

// New creates a new instance of the SNS counter.
func New(svc snsiface.SNSAPI) *SNS {
	return &SNS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *SNS) Counters() map[string]int64 {
...
func (c *SNS) incViaRequestOption(op string) request.Option {
