...
// Snowball counts the API operations made to Amazon Import/Export Snowball.
type Snowball struct {
	svc    snowballiface.SnowballAPI
	counts sync.Map
}

var _ snowballiface.SnowballAPI = &Snowball{}

// New creates a new instance of the Snowball counter.
func New(svc snowballiface.SnowballAPI) *Snowball {
	return &Snowball{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Snowball) Counters() map[string]int64 {
...
func (c *Snowball) incViaRequestOption(op string) request.Option {
