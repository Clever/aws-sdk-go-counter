...
// Pinpoint counts the API operations made to Amazon Pinpoint.
type Pinpoint struct {
	svc    pinpointiface.PinpointAPI
	counts sync.Map
}

var _ pinpointiface.PinpointAPI = &Pinpoint{}

// New creates a new instance of the Pinpoint counter.
func New(svc pinpointiface.PinpointAPI) *Pinpoint {
	return &Pinpoint{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *Pinpoint) Counters() map[string]int64 {
...
func (c *Pinpoint) incViaRequestOption(op string) request.Option {
