...
// S3 counts the API operations made to Amazon Simple Storage Service.
type S3 struct {
	svc    s3iface.S3API
	counts sync.Map
}

var _ s3iface.S3API = &S3{}

// New creates a new instance of the S3 counter.
func New(svc s3iface.S3API) *S3 {
	return &S3{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *S3) Counters() map[string]int64 {
...
func (c *S3) incViaRequestOption(op string) request.Option {
