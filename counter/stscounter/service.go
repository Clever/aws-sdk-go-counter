...
// STS counts the API operations made to AWS Security Token Service.
type STS struct {
	svc    stsiface.STSAPI
	counts sync.Map
}

var _ stsiface.STSAPI = &STS{}

// New creates a new instance of the STS counter.
func New(svc stsiface.STSAPI) *STS {
	return &STS{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *STS) Counters() map[string]int64 {
...
func (c *STS) incViaRequestOption(op string) request.Option {
