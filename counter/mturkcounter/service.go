...
// MTurk counts the API operations made to Amazon Mechanical Turk.
type MTurk struct {
	svc    mturkiface.MTurkAPI
	counts sync.Map
}

var _ mturkiface.MTurkAPI = &MTurk{}

// New creates a new instance of the MTurk counter.
func New(svc mturkiface.MTurkAPI) *MTurk {
	return &MTurk{svc: svc}
}

// Counters returns a snapshot of current counter values for each API operation.
func (c *MTurk) Counters() map[string]int64 {
...
func (c *MTurk) incViaRequestOption(op string) request.Option {
